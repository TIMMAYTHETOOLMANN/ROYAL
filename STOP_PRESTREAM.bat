@echo off
REM Stop and remove all pre-stream monitors

echo.
echo Stopping all pre-stream monitors...
docker stop trovo-prestream kick-prestream youtube-prestream twitch-prestream rumble-prestream 2>nul

echo Removing containers...
docker rm trovo-prestream kick-prestream youtube-prestream twitch-prestream rumble-prestream 2>nul

echo.
echo ✅ All pre-stream monitors stopped and removed.
echo.
pause
@echo off
REM ============================================
...
echo.
echo Stop all: docker stop trovo-prestream kick-prestream youtube-prestream twitch-prestream rumble-prestream
echo Remove all: docker rm trovo-prestream kick-prestream youtube-prestream twitch-prestream rumble-prestream
echo.
pause
